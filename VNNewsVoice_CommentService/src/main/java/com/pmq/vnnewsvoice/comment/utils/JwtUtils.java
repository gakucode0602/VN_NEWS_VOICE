package com.pmq.vnnewsvoice.comment.utils;
...
/**
 * JWT utility for CommentService — verify only (no signing). JWT tokens are issued exclusively by
 * AuthService; this service only validates them.
 */
@Component
