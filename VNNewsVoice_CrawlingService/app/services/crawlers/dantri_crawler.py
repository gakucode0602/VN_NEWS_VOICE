...
class DanTriCrawler(BaseCrawler):
    def __init__(self):
        super().__init__(
            source_name="dantri", base_url="https://dantri.com.vn/", rate_limit=3
        )
        self.rss_url = "https://dantri.com.vn/rss/home.rss"
    ...
    async def get_rss_feed_urls(
        ...
        try:
            ...
            for entry in feed.entries:
                ...
                data.append((entry.link, entry.title))
                count += 1
    ...
    async def crawl_article(
        ...
        try:
            ...
            sapo_tag = soup.select_one(
                "div.singular-sapo, div.sapo, p.sapo, .article-sapo, h2.dt-font-arial.dt-font-normal.dt-text-lg.dt-leading-160.dt-text-black-mine"
            )
            if sapo_tag:
            ...
            potential_containers = [
                "#desktop-in-article",  # Most reliable: specific ID for article content
                "div[data-slot='content']",  # Very reliable: specific data attribute
                "div.singular-content",  # Older Dantri layout
            ...
            return CrawlResult(
                title=title,
                top_image=top_image,  # Move to position #2
                url=url,
                published_at=None,
                blocks=blocks,
                success=True,
