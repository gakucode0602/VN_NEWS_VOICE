...
class VnExpressCrawler(BaseCrawler):
    def __init__(self):
        super().__init__(
            source_name="vnexpress", base_url="https://vnexpress.net/", rate_limit=3
        )
        self.rss_url = "https://vnexpress.net/rss/tin-moi-nhat.rss"
    ...
    async def crawl_article(
        ...
        try:
            ...
            sapo_tag = soup.select_one("p.description, p.lead, .article-sapo")
            if sapo_tag:
